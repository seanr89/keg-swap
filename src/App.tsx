...
const INITIAL_EVENTS: BeerEvent[] = [
];

const TEST_EVENTS: BeerEvent[] = [
  {
    id: '1',
    name: 'Craft IPA Tap Takeover',
    date: '2026-07-20',
    address: 'The Rusty Anchor, 42 Pine St, Portland',
    status: 'Upcoming',
    drinks: [
      {
        id: 'd1-1',
        ...
        reviews: [
          {
            ...
            reviewer: 'Sarah M.',
            rating: 5,
            comment: 'Incredibly smooth porter. The plum notes really shine through without being overly sweet. Full-bodied and satisfying.',
          ...
          },
          {
            ...
            reviewer: 'James K.',
            rating: 4,
            comment: 'Very solid porter. Classic dark profiles with a clean finish. Nice roasted malt aroma.',
      ...
      },
      {
        ...
        abv: '6.5%',
        style: 'IPA',
        description: 'Bright citrus, piney bitterness, hazy glow',
        reviews: []
      }
    ]
  },
  {
    id: '2',
    name: 'Imperial Stout & Oyster Night',
    date: '2026-07-12',
    address: 'Black Velvet Lounge, 303 Yeast Rd, Boston',
    status: 'Ongoing',
    drinks: [
      {
        id: 'd2-1',
        ...
        description: 'Decadent chocolate, espresso roast, velvet texture',
        reviews: [
          {
            id: 'r3',
            reviewer: 'Dave P.',
            rating: 5,
            comment: 'Absolutely spectacular. Thick, rich, and perfect for pairing with raw oysters. Highly recommended!',
            createdAt: '2026-07-12T19:45:00Z'
          }
        ]
      }
    ]
  ...
  {
    id: '3',
    name: 'Summer Sour Beer Festival',
    date: '2026-08-05',
    address: 'Greenwood Park Beer Garden, Seattle',
    status: 'Upcoming',
    drinks: [
      {
        id: 'd3-1',
        ...
        description: 'Tart raspberry juice, crisp wheat finish, effervescent',
        reviews: []
      }
    ]
  }
